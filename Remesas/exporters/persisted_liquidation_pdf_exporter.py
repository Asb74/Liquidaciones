...
def build_premium_view_model_from_persisted(
    ...
    return PremiumLiquidationViewModel(
        ...
        rotten_amount=z, rotten_price=None, national_market_price=None, rotten_leaves_price=None,
        gross_average_price=(gross / net if net else None), commercial_breakdown_title="DESGLOSE COMERCIAL",
