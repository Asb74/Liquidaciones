...
from domain.liquidacion_calculator import calculate_vat, calculate_withholding, calculate_total
...
class CalculationStateTests(unittest.TestCase):
    ...
    def test_tax_helpers(self):
        ...
        wh = calculate_withholding(base, Decimal("2"))
        self.assertEqual(vat, Decimal("12.00"))
        self.assertEqual(wh, Decimal("2.00"))
        self.assertEqual(calculate_total(base, vat, wh), Decimal("110.00"))
